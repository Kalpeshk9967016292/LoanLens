    ...
    return (
        <section className="container py-12">
            <div className="prose dark:prose-invert max-w-full">
                ...
                <h3 className="text-xl font-semibold mt-6 mb-2 font-headline">Understanding Different Loan Types</h3>
                <p>LoanLens is equipped to handle various types of loans, each with its own purpose and structure. Whether you are considering a <strong>Personal Loan</strong> for immediate needs, a <strong>Home Loan</strong> for your dream house, a <strong>Car Loan</strong> for a new vehicle, or an <strong>Education Loan</strong> for academic pursuits, our tools can provide the necessary calculations. By understanding the amortization schedule and total interest payable for each, you can make a choice that aligns with your long-term financial goals.</p>

                <h3 className="text-xl font-semibold mt-6 mb-2 font-headline">Choosing Between Banks and NBFCs</h3>
                <p>When seeking a loan, you'll encounter offers from both traditional <strong>banks</strong> and <strong>Non-Banking Financial Companies (NBFCs)</strong>. Banks often offer competitive interest rates and are highly regulated, providing a sense of security. NBFCs, on the other hand, might offer more flexible eligibility criteria and faster processing times. Our Loan Comparison tool is the perfect ally in this decision-making process. You can input loan offers from both types of institutions to objectively compare the monthly EMI, interest outgo, and overall cost, helping you see beyond the advertised rates and choose the best financial partner for your needs.</p>
          ...
          <footer className="py-6 md:px-8 md:py-0 border-t">
            <div className="container flex flex-col items-center justify-center gap-4 md:h-24 md:flex-row">
              <p className="text-center text-sm leading-loose text-muted-foreground">
                © 2025, made with Love by I am Tiksha & NicSync for a better web.
              </p>
            </div>
          </footer>
